...
function NotFoundComponent() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center brutal-border bg-card p-10" style={{ boxShadow: "10px 10px 0 0 var(--primary)" }}>
        <p className="text-[10px] font-bold uppercase tracking-widest text-primary">// Error</p>
        <h1 className="mt-2 text-7xl font-extrabold uppercase tracking-tighter text-foreground">404</h1>
        <h2 className="mt-2 text-xl font-extrabold uppercase tracking-tight text-foreground">Page not found</h2>
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A modern webcomic blog. Fresh strips every week — playful, weird, and a little wonderful." },
