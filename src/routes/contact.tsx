...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Say hi, send a commission inquiry, or subscribe to the Inkwell newsletter." },
...
function ContactPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 md:px-6 md:py-24">
      <p className="text-[10px] font-bold uppercase tracking-widest text-primary">// Contact / Form</p>
      ...
      <div className="mt-10 grid gap-0 sm:grid-cols-3 brutal-border">
        <a href="mailto:hi@inkwell.studio" className="flex items-center gap-3 border-b-[3px] border-foreground bg-card p-4 transition-smooth hover:bg-primary hover:text-primary-foreground sm:border-b-0 sm:border-r-[3px]">
          <Mail className="h-4 w-4" />
          <span className="text-xs font-bold uppercase tracking-widest">hi@inkwell.studio</span>
        </a>
        <a href="#" className="flex items-center gap-3 border-b-[3px] border-foreground bg-card p-4 transition-smooth hover:bg-primary hover:text-primary-foreground sm:border-b-0 sm:border-r-[3px]">
          <Instagram className="h-4 w-4" />
          <span className="text-xs font-bold uppercase tracking-widest">@inkwell.strips</span>
        </a>
        <a href="#" className="flex items-center gap-3 bg-card p-4 transition-smooth hover:bg-primary hover:text-primary-foreground">
        ...
        <div className="space-y-4 p-6">
          <div className="grid gap-4 sm:grid-cols-2">
            <label className="block">
              <span className="mb-1 block text-[10px] font-bold uppercase tracking-widest">Name</span>
              <input
                required
            ...
            <label className="block">
              <span className="mb-1 block text-[10px] font-bold uppercase tracking-widest">Email</span>
              <input
                required
                type="email"
                className="h-11 w-full brutal-border bg-background px-3 text-sm outline-none focus:bg-secondary"
          ...
          <label className="block">
            <span className="mb-1 block text-[10px] font-bold uppercase tracking-widest">Message</span>
            <textarea
              required
              rows={5}
